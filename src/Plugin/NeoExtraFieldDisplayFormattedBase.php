 ...
 */
abstract class NeoExtraFieldDisplayFormattedBase extends NeoExtraFieldDisplayBase implements NeoExtraFieldDisplayFormattedInterface {
  ...
  public function getFieldName() {
    ...
    return 'neo_extra_field_' . $this->pluginId;
  }
