 ...
 */
abstract class NeoExtraFieldManagerBase extends DefaultPluginManager implements NeoExtraFieldManagerBaseInterface {
  ...
  protected function fieldName($pluginId) {
    return static::NEO_EXTRA_FIELD_PREFIX . $pluginId;
  }
