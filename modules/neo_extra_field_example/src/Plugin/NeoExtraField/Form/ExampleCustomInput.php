 ...
 * )
 */
class ExampleCustomInput extends NeoExtraFieldFormBase implements ContainerFactoryPluginInterface {
  ...
  public function formElement(array &$complete_form, FormStateInterface $form_state) {
    $element = [];
    $element[self::VOUCHER_CODE_FIELD] = [
      '#type' => 'textfield',
      '#title' => $this->t('Voucher code'),
      '#required' => TRUE,
      '#size' => 30,
    ];
    $element['#validate'][] = [$this, 'validateVoucherCode'];
    return $element;
  }
